package dev.ihorshulha.externalapiintegration.integrationTest;
...
class CatRestControllerV1IntegrationTest {
    ...
    void getCatById_returnsErrorDto_whenCatNotFoundInCatApi() throws Exception {
        ...
        mockMvc.perform(org.springframework.test.web.servlet.request.MockMvcRequestBuilders.get("/api/v1/cats/4044"))
                ...
                .andExpect(org.springframework.test.web.servlet.result.MockMvcResultMatchers.jsonPath("$.code", is("EXTERNAL_API_ITEM_NOT_FOUND")))
                .andExpect(org.springframework.test.web.servlet.result.MockMvcResultMatchers.jsonPath("$.message", is("Item not found in the external API")))
                .andExpect(org.springframework.test.web.servlet.result.MockMvcResultMatchers.jsonPath("$.path", containsString("/api/v1/cats/4044")))
